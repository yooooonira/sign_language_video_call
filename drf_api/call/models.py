...
class CallHistory(models.Model):
    ...
    caller: models.ForeignKey = models.ForeignKey(
    ...
    call_status: models.CharField = models.CharField(
        max_length=10, choices=CALL_STATUS_CHOICES
    )
    called_at: models.DateTimeField = models.DateTimeField(auto_now_add=True)

    room_id: models.CharField = models.CharField(
        max_length=22, unique=True, default=gen_room_id
    )
